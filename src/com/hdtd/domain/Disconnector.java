...
public class Disconnector extends BasicPojo{
...
//	}
	...
	public String toString() {
		return "Disconnector [fileFrom=" + super.getFileFrom() + ", p2_CusVars=" + p2_CusVars + ", fill_bounds=" + fill_bounds + ", lw=" + lw + ", groupObjId="
