...
public class Pdtransformer extends BasicPojo{
...
//	}
	...
	public String toString() {
		return "Pdtransformer [fileFrom=" + super.getFileFrom() + ", p2_CusVars=" + p2_CusVars + ", fill_bounds=" + fill_bounds + ", lw=" + lw + ", groupObjId="
